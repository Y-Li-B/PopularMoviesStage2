...
public class NetworkUtils {
    ...
    public final static String SORT_ORDER_POPULAR = "/movie/popular";
   public final static String SORT_ORDER_HIGHEST_RATED = "/movie/top_rated";
    ...
    public static String buildPosterURL(String path) {
        ...
        Uri uri = Uri.parse(BASE_POSTER_URL).buildUpon().appendPath(IMAGE_SIZE).build();
    ...
    /**
     * Builds a URL which is used to get a list of movies depending on the supplied sort order.
     *
    ...
    static private String buildSortedMoviesURL(String sortOrder) {

        final String SORTED_BASE_URL = BASE_URL + sortOrder;

        Uri uri = Uri.parse(SORTED_BASE_URL).buildUpon()
    ...
    static private Review[] parseReviewResponse(String json)throws JSONException{
        if (json != null) {
    ...
    public static Movie[] getMovieList(String sortOrder) throws IOException, JSONException{
        String discoverUrl = buildSortedMoviesURL(sortOrder);
        String movieListResponse = getResponse(discoverUrl);
        return parseMovieListResponse(movieListResponse);
    }

    //Build, get a response , then parse and return.
    public static String[] getTrailerKeys(String movieId) throws IOException, JSONException{
    ...
    public static Uri getYoutubeLink(String movieKey) {
    ...
    public static Review[] getReviews(String movieId) throws IOException, JSONException {
        String reviewUrl = buildMovieReviewURL(movieId);
        String response = getResponse(reviewUrl);
